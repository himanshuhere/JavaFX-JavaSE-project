...
public class FXMi2Controller implements Initializable {
    ...
    void nextapp2Action(ActionEvent event) throws IOException {
        ...
        Stage end = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("FXMi3.fxml"));
    ...
    void previousapp2Action(ActionEvent event) throws IOException {
        ...
        Stage end = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("FXMi1.fxml"));
