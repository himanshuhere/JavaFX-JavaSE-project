...
public class FXApple2Controller implements Initializable {

    /**
     * Initializes the controller class.
     */
        @FXML
    private AnchorPane apple2;
    ...
    void nextapp2Action(ActionEvent event) throws IOException {
        ...
        Stage end = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("FXApple3.fxml"));
    ...
    void previousapp2Action(ActionEvent event) throws IOException {
        ...
        Stage end = new Stage();
        Parent root = FXMLLoader.load(getClass().getResource("FXApple1.fxml"));
