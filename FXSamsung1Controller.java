...
public class FXSamsung1Controller implements Initializable {
    ...
    @FXML
    void nextsam1Action(ActionEvent event) throws IOException {
          nextsam1_btn.getScene().getWindow().hide();
